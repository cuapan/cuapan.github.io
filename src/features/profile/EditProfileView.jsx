...
const EditProfileView = ({ user }) => {
    ...
    const onProfilePicChanged = e => setProfilePic([...e.target.files])
        ...
        <div  >
            ...
            <form onSubmit={onSaveUserClicked}>
                <div className="mb-3">
                    ...
                    <input className="form-control" type="file" id="formFile" onChange={onProfilePicChanged} accept="image/*" />
                </div>
                <div className="mb-3">
                ...
                <div className="mb-3">
                    ...
                    <div className="d-flex">
                        <select name="year" id="year" value={year} onChange={onYearChanged} className="form-select flex-column me-2">
                        ...
                        <select name="day" id="day" value={day} onChange={onDayChanged} className="form-select flex-column  p-1">
