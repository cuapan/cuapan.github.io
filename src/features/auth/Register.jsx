...
const Register = () => {
  ...
  const canSave =
    [validUsername, validPassword, email, name, dob].every(Boolean) &&
    !isLoading;
  const canSavebutton = canSave
  ...
  const content = (
    <>
      <PublicHeader />
      <main className="form-signin mx-auto border">
        {isLoading && <PublicLoading />}
        {error && <p className={errClass}>{error?.data?.message}</p>}
        <h1 className="text-light border mx-0">Register</h1>
        <form onSubmit={onSaveUserClicked}>
          ...
          <div className="">
            ...
            <div className="d-flex">
              <select
                ...
                className="form-select flex-column me-2"
              >
              ...
              <select
                ...
                className="form-select flex-column  p-1"
              >
                <option disabled className="text-muted">
                  Day
                </option>
          ...
          <hr />
          <div className="">
            <button className={canSavebutton} disabled={!canSave}>
              Sign Up
            </button>
          </div>
        </form>
